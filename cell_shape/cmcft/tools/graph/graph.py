...
def extract_cell_stats(img1_path, img2_path):
    ...
    # read image data
    img1 = ftracker.w_thresh(skimage.io.imread(img1_path))
    img2 = ftracker.w_thresh(skimage.io.imread(img2_path))
    
    labels_new, nlabs = ndi.label(img1)
    img1 = ftracker.filter_by_size(labels_new)
    
    labels_new, nlabs = ndi.label(img2)
    img2 = ftracker.filter_by_size(labels_new)
